...
//xj-zhang
void FlightTasks::_reset_yaw_setpoint()
{
	_current_task->_reset_yaw_setpoints();
}
void FlightTasks::_reset_z_setpoint(float delta)
{
	_current_task->_reset_z_setpoints(delta);
}
